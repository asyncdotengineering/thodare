# Thodare research — World abstraction (May 2026)

> Research artifacts for the planned Thodare **World** / Ports-and-Adapters layer. Authored 2026-05-02 in one extended research session. Purpose: give the next session enough context + cited research to open the RFC at `rfcs/world-abstraction/` without re-deriving the same ground.

## Read order

If you read nothing else, read [`world-abstraction-proposal.md`](./world-abstraction-proposal.md). It's the load-bearing artifact; everything else is supporting evidence.

For the full context dive:

1. **[`world-abstraction-proposal.md`](./world-abstraction-proposal.md)** — the proposal. Vision, interface design, adapter roster, migration path, success metrics, open decisions. ~5k words.
...
|---|---|---|---|
| `vercel/workflow` | `../../workflow/` | Apache-2.0 | The WDK source — read for the World contract pattern; closest peer to where Thodare wants to go |
...
- The RFC itself. That belongs at `rfcs/world-abstraction/README.md`. This proposal is its source material, not a substitute.
...
- [x] Rivet research
- [x] Flue research
- [x] Cloudflare-as-World research
